...
#include <iostream>
using namespace std;
void llenarArr(int [], int, int, int *); //aqui se declara la funcion llenarArr, que recibe un arreglo de enteros, dos numeros enteros y un puntero a entero, que es para saber el tamaño del arreglo que se lleno.
void mostrarArr(int[], int); //lo mismo pero para la funcion mostrarArr, que recibe un arreglo de enteros y un entero que es el tamaño del arreglo que se lleno.
